          ...
          >
            ...
            <Box display={"flex"} width={"100%"} gap={"20px"}>
              ...
              <Typography
                ...
                lineHeight={"30px"}
                textAlign={"center"}
                sx={{ "& > span": { fontWeight: "bold", fontSize: "1.3rem" } }}
              >
                <span>L</span>orem ipsum dolor sit amet, consectetur adipiscing
                elit. Vestibulum vitae lectus at libero venenatis commodo. Fusce
                vel eleifend mauris. Sed efficitur lacus vel bibendum vulputate.
                ...
                ut purus nec tortor eleifend rhoncus. Suspendisse potenti.In hac
                habitasse platea dictumst. Integer sed lectus auctor, suscipit
                nisl in, bibendum dui. Vivamus sit amet metus ut elit auctor
                tincidunt. Proin in sagittis arcu. Quisque ut purus nec tortor
                eleifend rhoncus. Suspendisse potenti.
              </Typography>
            </Box>
          </Box>
        </Box>
